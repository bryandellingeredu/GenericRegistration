        ...
        <SegmentGroup>
          <Segment>
           <h3> Operations Security (OPSEC) is a process of identifying critical information and subsequently analyzing friendly actions attendant to military operations.
            ...
            <Segment>
                {!showCUIInfo && 
                <Button basic color='blue' onClick={() => setShowCUIInfo(true)}>Show More Information About CUI and PII </Button>
               }
              { showCUIInfo && 
                <Button basic color='blue' onClick={() => setShowCUIInfo(false)}>Show Less Information About CUI and PII </Button>
               }
