...
export default function DocumentStep(
    {documentLibraryContent, formisDirty, setContent, setFormDirty, savingFromStepClick, treeData, registrationEventId, saving, saveForm } : Props
){
        ...
        <Grid  stackable style={{ marginTop: '20px', padding: '40px' }}>
            <Grid.Row>
              ...
              <Header as='h2' textAlign="center">
                ...
                <CreateUpdateRegistrationInfo content={documentLibraryContent} setContent={setContent} setFormDirty={setFormDirty}/>
