  ...
  return (
    <Form>
      <FormField required error={!registrationEvent.certified && formSubmitted}>
        <label>
          I certify I will{' '}
          <span style={{ color: 'red', fontWeight: 'bold', fontSize: 'large' }}>
            NOT
          </span>
          ...
          <Button
            ...
            size="tiny"
            content="PII"
            onClick={handleCertifyButtonClick}
          />
          ...
          <Button
            ...
            onClick={handleCertifyButtonClick}
          />
          such as: Social Security #s, personal medical, personal finance, or
          personal family information when creating questions.
        </label>
        <Radio
          slider
      ...
      <FormField
        error={
          (!registrationEvent.title || !registrationEvent.title.trim()) &&
          formSubmitted
        }
        required
      >
      ...
      <FormField
        error={
          (!registrationEvent.location || !registrationEvent.location.trim()) &&
          formSubmitted
        }
        required
      >
