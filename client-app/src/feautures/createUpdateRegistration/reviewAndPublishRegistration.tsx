      ...
      <Message info>
        ...
        {!registrationEvent.published && (
          <Message.Content>
            <p>
              {' '}
              When you are satisfied with your website{' '}
              <Button
                basic
                color="blue"
                size="tiny"
              ...
              your website so that user's may register.
            </p>
            <p>
              {' '}
              To make changes to your website go back to the{' '}
              <Button basic color="blue" size="tiny" onClick={setActiveStep}>
                Design Screen
              </Button>
              .
            </p>
        ...
        {registrationEvent.published && (
          <Message.Content>
            <p>
              {' '}
              This event has been published. The link for the registration page
              is
              <a href={`${baseUrl}/registerforevent/${registrationEventId}`}>
                <strong>{` ${baseUrl}/registerforevent/${registrationEventId}`}</strong>
              </a>
              <Button
                basic
                color="blue"
                size="tiny"
                content="copy registration link to clipboard"
                style={{ marginLeft: '5px' }}
                onClick={copyLink}
              />
            </p>
            <p>
              To create and download a QR Code{' '}
              <Button
                basic
                color="blue"
                size="tiny"
            ...
            <p>
              <Button
                ...
                loading={publishing}
              />{' '}
              your event to stop users from registering
            </p>
          </Message.Content>
        )}
      </Message>
      <Menu inverted color="black" widths={2}>
        ...
        <Menu.Item>
          <Header as="h4" inverted>
            ...
            <Header.Content>The Registrant's Name</Header.Content>
          </Header>
        </Menu.Item>
      </Menu>
      ...
      <Grid stackable style={{ padding: '40px' }}>
        <Grid.Row>
          <Grid.Column width={8}>
            <Header as="h3">
              <Icon name="pencil" />
              <Header.Content>{registrationEvent.title}</Header.Content>
            </Header>
            <Header as="h3">
              <Icon name="map marker alternate" />
              <Header.Content>{registrationEvent.location}</Header.Content>
            </Header>
            <Header as="h3">
              <Icon name="calendar" />
              <Header.Content>
