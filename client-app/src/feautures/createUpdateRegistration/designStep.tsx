...
export default function DesignStep(
    {registrationEvent, setRegistrationEvent, formSubmitted, setFormDirty, content, setContent,
    registrationEventOwners, setRegistrationEventOwners, registrationEventId, saveFormInBackground,
     userEmails, formisDirty, savingFromStepClick, saving, saveForm, registeredUsersIndicator,
     customQuestions, setCustomQuestions, handleReviewClick
    } : Props
){
    return(
    <Grid  stackable style={{ marginTop: '20px', padding: '40px' }}>
                <Grid.Row>
                    ...
                    <Header as='h2' textAlign="center">
                        ...
                        <CreateUpdateRegistrationInfo content={content} setContent={setContent} setFormDirty={setFormDirty}/>
