import { Button, ButtonContent, ButtonGroup, Divider, DropdownProps, FormField, Icon, Input, Loader, Select } from "semantic-ui-react"
...
export default function CustomQuestionComponentForRegistrant(
    {question, customQuestions, registrationIsOpen, registration, formisDirty, findAnswerAttachmentByQuestionId,
     answerAttachments, setAnswerAttachments, downloadAttachment, deleteAttachment, setRegistration, extendedOptions} :Props){
