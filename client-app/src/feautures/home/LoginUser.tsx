...
export default observer(function LoginUser() {
  ...
  const handleSendLink = () => {
    if (
      redirectToPage &&
      redirectToPage.toLocaleLowerCase().includes('registerforevent')
    ) {
    ...
    if (
      redirectToPage &&
      redirectToPage.toLocaleLowerCase().includes('documentlibraryforevent')
    ) {
      const guid = redirectToPage.split('/').pop();
          ...
          <Segment color="black">
            <Grid
              columns={
                ...
                (redirectToPage
                  .toLocaleLowerCase()
                  .includes('registerforevent') ||
                  redirectToPage
                    .toLocaleLowerCase()
                    .includes('documentlibraryforevent'))
                  ? loginType
                    ? 2
                    : 3
                  : loginType
              ...
              <Grid.Row verticalAlign="middle">
                ...
                {(!loginType || loginType === 'CAC') && (
                  <Grid.Column>
                    ...
                    <Button basic onClick={handleLoginCAC}>
                      Sign In
                    </Button>
                  </Grid.Column>
                )}
                {redirectToPage &&
                  ...
                  !loginType && (
                    <Grid.Column>
                      ...
                      <Button basic onClick={handleSendLink}>
                        Send Link
                      </Button>
                    </Grid.Column>
                  )}
                ...
                {(!loginType || loginType === 'EDU') && (
                  <Grid.Column>
                    ...
                    <Login
                      loginCompleted={loginCompleted}
                      loginInitiated={loginInitiated}
                      logoutCompleted={logoutComplete}
                    />
                  </Grid.Column>
                )}
                {redirectToPage &&
