...
export default function DocumentLibraryWidget({uploadDocuments,registrationEventId } : Props){
            ...
            <Grid>
              <Grid.Row>
                <Grid.Column width={16}>
                  <DocumentLibraryUploadWidgetDropzone setFiles={onFileAdded} error={false}/>
                  {files.length > 0 && (
